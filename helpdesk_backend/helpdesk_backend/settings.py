...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:5174",  # Your backend's origin
]
...
CSRF_TRUSTED_ORIGINS = ['http://localhost:5174', 'http://127.0.0.1:5174']  # Add your frontend origins
